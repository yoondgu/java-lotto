...
5. - [x] **추첨 번호와 보너스 번호**로 이루어진 **로또 당첨 번호**를 생성하는 기능
      - [x] `예외처리` : 추첨 번호의 개수가 정해진 개수와 다른 경우
      - [x] `예외처리` : 추첨 번호에 정해진 범위 밖의 수가 포함된 경우
      - [x] `예외처리` : 추첨 번호에 중복되는 수가 존재하는 경우
...
- [기능5] 로또 당첨 번호 생성 시 예외 발생 테스트
  - [x] 추첨 번호의 개수가 6개가 넘어가면 예외가 발생
  - [x] 추첨 번호에 중복된 숫자가 있으면 예외가 발생
  - [x] 추첨 번호에 범위 밖의 숫자가 있으면 예외가 발생
